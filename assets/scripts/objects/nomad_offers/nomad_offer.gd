...
func _get_description() -> String:
	...
	return tr("object.nomad." + _get_script_name().to_snake_case().to_lower().replace("_", ".")).format(values)
...
func _get_fail_message() -> String:
	return tr("object.nomad." + _get_script_name().to_snake_case().to_lower().replace("_", "."))
